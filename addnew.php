  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        ...
        <a href="inventeries.php"><li><i class="fa fa-circle-o fa-fw"></i> Availability Check</li></a>
...
if ($con->query("insert into inventeries (catId,name,price,description) values ('$_POST[catId]','$_POST[name]','$_POST[price]','$_POST[description]')")) {
  $notice ="<div class='alert alert-success'>Successfully Saved</div>";
}
else{
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <form method="POST">
         <div class="form-group">
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">Availability</label>
            <input type="text" name="available"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
          ...
          <textarea class="form-control" name="Description" required placeholder="Write some discription"></textarea> 
          </div>
          <div class="center">
