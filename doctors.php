  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        ...
        <a href="inventeries.php"><li style="color: "><i class="fa fa-circle-o fa-fw"></i> Inventeries</li></a>
        <a href="doctors.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Doctors</li></a>
...
if (isset($_GET['catId']))
{
  ...
  $stockArray = $con->query("select * from doctors where catId='$catArray[id]'");
 
}
else
{
  $catName = "All Inventeries";
  $stockArray = $con->query("select * from doctors");
}
